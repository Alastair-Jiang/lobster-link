...
- `ok`：**24**
- `fail`/`stall`：**16**
- 失败清单：AAPL_revin-DLinear:stall、MSFT_revin-DLinear:stall、META_revin-DLinear:stall、JPM_revin-DLinear:stall、WMT_revin-DLinear:stall、N225_revin-DLinear:stall、GDAXI_revin-DLinear:stall、HSI_revin-DLinear:stall、FTSE_revin-DLinear:stall、GBPUSD_revin-DLinear:stall、AUDUSD_revin-DLinear:stall、USDCAD_revin-DLinear:stall、GOLD_revin-DLinear:stall、WTI_revin-DLinear:stall、GLD_revin-DLinear:stall、TLT_revin-DLinear:stall

## 产物

- `geng-lobster/T005-c1/2022/<TAG>_<MODEL>/`：`metrics.npy`、`pred.npy`、`true.npy`、`command.txt`、`log_tail.txt`
